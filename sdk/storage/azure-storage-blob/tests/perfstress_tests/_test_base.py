...
class _ServiceTest(PerfStressTest):
    ...
    def add_arguments(parser):
        ...
        parser.add_argument('--connection-block-size', nargs='?', type=int, help='The block size used when reading from the network stream. Defaults to 4*1024', default=4*1024)
